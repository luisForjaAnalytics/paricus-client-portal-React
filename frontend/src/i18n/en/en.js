export default {
  ...
  profile: {
    ...
    allPasswordFieldsRequired: "All password fields are required to change password",
  ...
  kpiControl: {
    ...
    subtitle: "Set the current values and targets. The badge will be green if the target is met, red if not.",
    achieved: "Achieved",
